...
# Add to your InputData class:
class InputData:
    def __init__(self):
        self.W_train = [...]  # 100 in-sample scenarios
        self.W_test = [...]   # 200 out-sample scenarios
        self.W = self.W_train + self.W_test
        self.p_nom = 600      # Maximum capacity
        self.T = [i for i in range(1,25)]  # Time periods if not already defined
