...
from adam_shit_code import P90BiddingModel

input_data = InputData()  # Your existing input data
input_data.p_nom = 600    # Set nominal power if not already set

p90_model = P90BiddingModel(input_data)
p90_model.run()

# Access results:
print(f"Final ALSO-X bid: {p90_model.results.also_x_bid} kW")
print(p90_model.results.p_analysis)
